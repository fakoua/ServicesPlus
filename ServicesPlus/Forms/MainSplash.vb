...
Friend NotInheritable Class MainSplash

    'TODO: This form can easily be set as the splash screen for the application by going to the "Application" tab
    '  of the Project Designer ("Properties" under the "Project" menu).


    Private Sub MainSplash_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
    ...
    Private Sub MainLayoutPanel_Click(sender As Object, e As EventArgs) Handles MainLayoutPanel.Click, ApplicationTitle.Click, Version.Click, Copyright.Click
        Close()
    End Sub
