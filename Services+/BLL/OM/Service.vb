Namespace BLL.OM
    Friend Class Service
        ...
        Dim _dependsOn As List(Of Service)
        Public Async Function DependsOnAsync(services As List(Of Service), identity As BLL.OM.Identity) As Threading.Tasks.Task(Of List(Of Service))
            If _dependsOn Is Nothing Then
        ...
        Dim _dependOnThisService As List(Of Service)
        Public Async Function DependOnThisServiceAsync(services As List(Of Service), identity As BLL.OM.Identity) As Threading.Tasks.Task(Of List(Of Service))
