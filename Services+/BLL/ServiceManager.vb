...
Namespace BLL
    Friend Class ServiceManager
        ...
        Private _tcsListServices As TaskCompletionSource(Of List(Of Service))
        Private _tcsService As TaskCompletionSource(Of Service)
        Private _tcsPerformance As TaskCompletionSource(Of PerformanceEntity)
        Private _tcsWmiReturn As TaskCompletionSource(Of ControlEntry)

        Public Sub New()

        End Sub

        Public Sub New(machineName As String, identity As Identity)
        ...
        Public Async Function GetServicesByMachineAsync() As Task
            Trace()
            Try
                _tcsListServices = New TaskCompletionSource(Of List(Of Service))
        ...
        Public Async Function GetPerformanceAsync(service As Service) As Task(Of PerformanceEntity)
            Trace()
            Try
                _tcsPerformance = New TaskCompletionSource(Of PerformanceEntity)()
        ...
        ''' <remarks></remarks>
        ''' 
        Public Async Function GetServiceByNameAsync(machine As String, serviceName As String) As Task(Of Service)
            Trace()
            Try
                _tcsService = New TaskCompletionSource(Of Service)
        ...
        Async Function ControlServiceAsync(service As Service, action As WmiMethod) As Task(Of ControlEntry)
            Trace()
            Try
        ...
        Private Sub ControlService(service As Service, action As WmiMethod)
            Dim rtnVal As New ControlEntry
