...
Namespace Forms
    ...
    Friend Class FrmMain
        ...
        Private Sub HttpServerToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles HttpServerToolStripMenuItem.Click
            Dim objHttpServer As New FrmHttpServer
            objHttpServer.ShowDialog()
            StartWebServer(objHttpServer.PortNumber)
        End Sub
